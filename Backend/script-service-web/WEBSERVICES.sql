...
CREATE SERVICE "liste" TYPE 'JSON' AUTHORIZATION OFF USER "DBA" METHODS 'GET' AS CALL getliste(:film, :livre);

CREATE SERVICE "tri" TYPE 'JSON' AUTHORIZATION OFF USER "DBA" METHODS 'GET' AS CALL tri(:groupe);

/*appel des tables pour créer le cache*/
CREATE SERVICE "film" TYPE 'JSON' AUTHORIZATION OFF USER "DBA" METHODS 'GET' AS CALL chercheFilm();

CREATE SERVICE "livre" TYPE 'JSON' AUTHORIZATION OFF USER "DBA" METHODS 'GET' AS CALL chercheLivre();